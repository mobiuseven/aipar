...
int sobel(unsigned char **brightness, unsigned char hdr[], char fname[], int width, int height){
  FILE *fp ;
...
int main(void){
  ...
  //apply median filter
  sobel(brightness, hdr, imgOUT, bmp.width, bmp.height) ;
